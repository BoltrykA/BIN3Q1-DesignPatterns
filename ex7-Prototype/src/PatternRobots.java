public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1 = new RobotAmelioreCanon(new RobotConcret.RobotBuilder("robot1")
				...
				.shield(2)
				.freq(100)
				.build()); // un robot avec un canon de 10, un bouclier de 2, une fréquence de tir de 100 et qui a reçu une amélioration de canon multipliant la puissance de ce dernier par 2.
		Robot robot2= new RobotAmelioreVie(new RobotConcret.RobotBuilder("robot2")
				.canon(9)
				.shield(3)
				.freq(90)
